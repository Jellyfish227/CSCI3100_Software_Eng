...
\ihead{Software Requirements Specification for Kaiju Academy}  % Inner header (left on odd, right on even pages)
...
\RedeclareSectionCommand[
  ...
  font=\normalfont\huge\bfseries\centering    % Centered, bold font
]{chapter}

% Style chapter titles with gray background
\renewcommand{\chapterformat}{\thechapter.}  % Chapter number followed by space
\renewcommand*{\chapterlinesformat}[3]{%
  \colorbox{gray!150}{%
    \parbox{\dimexpr\textwidth-2\fboxsep\relax}{%
      \centering\color{white}#2 #3%
    }%
  }%
}
