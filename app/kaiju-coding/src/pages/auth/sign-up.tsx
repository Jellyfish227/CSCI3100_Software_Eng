    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f5f5f7] p-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>Enter your information to create your Kaiju Academy account</CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-start space-x-2">
              ...
              <Label htmlFor="terms" className="text-sm font-normal">
                I agree to the{" "}
                <a href="#terms" className="text-[#4aafbf] hover:underline">
                  Terms of Service
                </a>{" "}
                and{" "}
                <a href="#privacy" className="text-[#4aafbf] hover:underline">
                  Privacy Policy
                </a>
              </Label>
            </div>
