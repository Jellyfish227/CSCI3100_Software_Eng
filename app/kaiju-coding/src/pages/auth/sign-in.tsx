    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f5f5f7] p-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-2xl font-bold">Sign in to Kaiju Academy</CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/password-reset" className="text-sm text-[#4aafbf] hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
        ...
        <CardFooter className="flex flex-col space-y-4">
          <div className="text-center text-sm">
            ...
            <Link to="/signup" className="text-[#4aafbf] hover:underline">
              Sign up
            </Link>
          </div>
        </CardFooter>
