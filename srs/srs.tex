...
\def\myversion{0.2}
\def\projectname{I have no idea what the project name is}  % Define project name variable
\date{}
%\title{%
...
% \lehead{Software Requirements Specification}  % Left header on even pages
%\cehead{}  % Center header on even pages (empty)
%\rehead{\headmark}  % Right header on even pages
% \lohead{Software Requirements Specification}  % Left header on odd pages
%\cohead{}  % Center header on odd pages (empty)
%\rohead{}  % Right header on odd pages
\ifoot{}  % Inner footer (empty)
\cfoot{}  % Center footer (empty)
\ofoot[\pagemark]{\pagemark}  % Outer footer with page number
...
\begin{titlepage}
    \begin{flushright}
        ...
        \begin{bfseries}
            ...
            \vspace{1.8cm}
            Prepared by Yu Ching Hei(1155193237)\\
            \vspace{1.8cm}
